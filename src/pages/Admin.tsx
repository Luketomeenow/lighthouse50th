          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="videoFile" type="file" accept="video/*" onChange={handleVideoUpload} disabled={isUploading} className="max-w-xl" />
                {isUploading && <p className="text-sm text-gray-500">Uploading video...</p>}
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="adminEmail" type="email" value={newAdminEmail} onChange={e => setNewAdminEmail(e.target.value)} placeholder="Enter admin email" className="max-w-xl" />
              </div>
