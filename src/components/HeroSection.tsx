...
const HeroSection = ({
  ...
  return <div className="relative min-h-screen bg-green-900 flex items-center overflow-hidden pt-20 w-full">
                ...
                <Drawer>
                  ...
                  <DrawerContent className="px-4 py-6 bg-black">
                    <div className="flex justify-center">
                      {showVideo && <video ref={videoRef} onLoadedData={handleVideoReady} onPlay={() => setIsPlaying(true)} onPause={() => setIsPlaying(false)} src="https://fwxblkgnyneqwotlsqss.supabase.co/storage/v1/object/public/videos//00af3f67-1dce-40fe-af62-2b534af8a691.mp4" controls className="max-w-full max-h-[70vh] rounded-lg" />}
                    </div>
                  </DrawerContent>
                </Drawer>
              </div>
